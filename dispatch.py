...
async def on_message(websocket, message, call_sid):
    ...
    # The event that carries our audio stream
        ...
        # This was randomly at the end of the "stop" call event. Not sure we need it
        my_assistant = VoiceAssistant('gpt-4')
        # It basically reinitizlied the global variable again, but we are creating a new voice assistant
        # for every call. Leaving it here to understand why
